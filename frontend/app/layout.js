    ...
    <html lang="en" className={`${inter.variable}`}>
      ...
      <body className={`${inter.className} antialiased bg-background text-text-primary`}>
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 bg-gray-900 text-white p-4 rounded-full shadow-lg hover:bg-gray-800 transition-all hover:scale-110 z-40 flex items-center justify-center border border-gray-700"
